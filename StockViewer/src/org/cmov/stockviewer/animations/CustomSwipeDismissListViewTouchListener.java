...
public class CustomSwipeDismissListViewTouchListener implements SwipeOnTouchListener {
	...
	private CustomOnDismissCallback mCallback;
	 ...
	 */
	public CustomSwipeDismissListViewTouchListener(AbsListView listView, CustomOnDismissCallback callback, CustomSwipeOnScrollListener onScroll) {
	...
	private boolean handleDownEvent(MotionEvent motionEvent) {
		...
		if (downView != null) {
			...
			// Disallow dismissing some views.
			if(!mCallback.isDismissable(downPosition)) {
				return false;
			}
